/**
 * @file
 * Example 025: Apply brand to envelope
 * @author DocuSign
 */
...
const eg025ApplyBrandToEnvelope = exports
 ...
 */
eg025ApplyBrandToEnvelope.createController = async (req, res) => {
    ...
    try {
        results = await eg025ApplyBrandToEnvelope.worker (args)
    }
    catch (error) {
 ...
 */
// ***DS.snippet.0.start
eg025ApplyBrandToEnvelope.worker = async (args) => {
 ...
 */
eg025ApplyBrandToEnvelope.getController = async (req, res) => {
    ...
    if (tokenOK) {
        ...
        res.render('pages/examples/eg025ApplyBrandToEnvelope', {
