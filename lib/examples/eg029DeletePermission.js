/**
 * @file
 * Example 029: Deleting a permission profile
 * @author DocuSign
 */
...
const eg029DeletePermission = exports
 ...
 */
eg029DeletePermission.createController = async (req, res) => {
    ...
    try {
        let resutls = await accountsApi.deletePermissionProfile(args.accountId, profileId)
 ...
 */
eg029DeletePermission.getController = async (req, res) => {
    ...
    if (tokenOK) {
        ...
        res.render('pages/examples/eg029DeletePermission', {
