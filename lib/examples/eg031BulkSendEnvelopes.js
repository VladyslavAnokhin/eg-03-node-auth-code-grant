...
eg031BulkSendEnvelopes.createController = async (req, res) => {
    ...
    try {
        ...
        //
        // Step 6: 
        // Add placeholder recipients. These will be replaced by the details provided in the Bulk List uploaded during Step 3
        ...
        results = await bulkEnvelopesApi.get(args.accountId, bulkResult.batchId)
    }
    catch (error) {
        console.log(error)
    ...
    if (results) {
        res.render('pages/example_done', {
            ...
            message: `Bulk request was sent to ${results.sent} user lists.`
        });
    }
}
